export const APP_NAME = "ReExplain";
...
export const LOGIN_DIALOG_DESCRIPTION =
	"Sign in with Google to save your progress, track your understanding, and keep learning where you left off.";
